...
int main(void)
{
  ...
  MediaPlayer_Init();
  /* USB FS UAC/HID is intentionally parked while Ethernet is debugged. */
  /* USBPCAudio_Init(); */
  USBStorage_Init();
  NetworkManager_Init();
  ...
  networkTaskHandle = osThreadNew(NetworkManager_Task, NULL, &networkTask_attributes);

  /* creation of usbHostTask */
  usbHostTaskHandle = osThreadNew(USBStorage_Task, NULL, &usbHostTask_attributes);
...
void MPU_Config(void)
{
  ...
  */
  ...
  /* LwIP heap and Ethernet packet buffers: SRAM2, normal non-cacheable. */
  MPU_InitStruct.Number = MPU_REGION_NUMBER2;
  MPU_InitStruct.BaseAddress = 0x20048000U;
  ...
  /* Ethernet descriptors and zero-copy RX buffers: normal non-cacheable. */
